                                ...
                                <table class="table with-border">
                                    ...
                                    <tr v-for="(goods, index) in item.goodsList">
                                        ...
                                        <td>
                                            ...
                                            <div v-for="(applys, applysIndex) in goods.ckApplysEntities" style="margin-right: 10px;">
                                               {{applys.storeEntity.outLabel}}:{{applys.applyNumber}}{{goods.applyStandardName}},
                                            </div>
                                            </div>
