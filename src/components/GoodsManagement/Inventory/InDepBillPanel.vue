                    ...
                    <div class="col-md-6" v-for="(item, billIndex) in arr">
                        ...
                        <div class="box">
                            ...
                            <div class="box-footer">
                                <button class="printBtn" :id="billIndex">打印</button>
                            </div>
                        </div>
    ...
    export default {
        ...
        mounted() {
            ...
            $('body').on('click', '.printBtn', function (e) {
                ...
                // var oneGoods = `<div class="item_goods" style="width: 100%; display: inline-block"></div>`
                // $('#billView').append(oneGoods);
